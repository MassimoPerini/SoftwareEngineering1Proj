...
*/
    ...
    public void writeExcomunications() throws IOException {
        ...
        BonusMalusOnSettings bonusMalusEx13 = new BonusMalusOnSettings(-2, coloursEx13, ActionType.GENERAL);
        ...
        cards.add(cardEx13);
        int eraEx14 = 3;
        String nameEx14 = "ex_14_era_3";
        List<Effect> bonusMalusEffectsEx14 = new ArrayList<>();
        BonusMalusSet bonusMalusSetEx14 = new BonusMalusSet();
        List<String> coloursEx14 = new ArrayList<>();
        coloursEx14.add("BLUE");
        BonusMalusOnSettings bonusMalusEx14 = new BonusMalusOnSettings(0, coloursEx14, ActionType.END_GAME);
        List<BonusMalusOnSettings> bonusMalusListEx14 = new ArrayList<>();
        bonusMalusListEx14.add(bonusMalusEx14);
        bonusMalusSetEx14.addBonusMalusOnSettings(bonusMalusListEx14);
        DonateBonusMalusEffect bonusMalusEffectEx14 = new DonateBonusMalusEffect(bonusMalusSetEx14);
        bonusMalusEffectsEx14.add(bonusMalusEffectEx14);
        ExcomunicationCard cardEx14 = new ExcomunicationCard(eraEx14, nameEx14, bonusMalusEffectsEx14);
        cards.add(cardEx14);
        int eraEx15 = 3;
        String nameEx15 = "ex_15_era_3";
        List<Effect> bonusMalusEffectsEx15 = new ArrayList<>();
        BonusMalusSet bonusMalusSetEx15 = new BonusMalusSet();
        List<String> coloursEx15 = new ArrayList<>();
        coloursEx15.add("PURPLE");
        BonusMalusOnSettings bonusMalusEx15 = new BonusMalusOnSettings(0, coloursEx15, ActionType.END_GAME);
        List<BonusMalusOnSettings> bonusMalusListEx15 = new ArrayList<>();
        bonusMalusListEx15.add(bonusMalusEx15);
        bonusMalusSetEx15.addBonusMalusOnSettings(bonusMalusListEx15);
        DonateBonusMalusEffect bonusMalusEffectEx15 = new DonateBonusMalusEffect(bonusMalusSetEx15);
        bonusMalusEffectsEx15.add(bonusMalusEffectEx15);
        ExcomunicationCard cardEx15 = new ExcomunicationCard(eraEx15, nameEx15, bonusMalusEffectsEx15);
        cards.add(cardEx15);
        int eraEx16 = 3;
        String nameEx16 = "ex_16_era_3";
        List<Effect> bonusMalusEffectsEx16 = new ArrayList<>();
        BonusMalusSet bonusMalusSetEx16 = new BonusMalusSet();
        List<String> coloursEx16 = new ArrayList<>();
        coloursEx16.add("GREEN");
        BonusMalusOnSettings bonusMalusEx16 = new BonusMalusOnSettings(0, coloursEx16, ActionType.END_GAME);
        List<BonusMalusOnSettings> bonusMalusListEx16 = new ArrayList<>();
        bonusMalusListEx16.add(bonusMalusEx16);
        bonusMalusSetEx16.addBonusMalusOnSettings(bonusMalusListEx16);
        DonateBonusMalusEffect bonusMalusEffectEx16 = new DonateBonusMalusEffect(bonusMalusSetEx16);
        bonusMalusEffectsEx16.add(bonusMalusEffectEx16);
        ExcomunicationCard cardEx16 = new ExcomunicationCard(eraEx16, nameEx16, bonusMalusEffectsEx16);
        cards.add(cardEx16);
        int eraEx17 = 3;
        String nameEx17 = "ex_17_era_3";
        List<Effect> bonusMalusEffectsEx17 = new ArrayList<>();
        BonusMalusSet bonusMalusSetEx17 = new BonusMalusSet();
        List<Resource> activeListEx17 = new ArrayList<>();
        activeListEx17.add(Resource.VICTORYPOINT);
        BonusMalusOnEnd bonusMalusEx17 = new BonusMalusOnEnd(Resource.VICTORYPOINT, activeListEx17, ActionType.END_GAME, 0.2, true);
        List<BonusMalusOnEnd> bonusMalusListEx17 = new ArrayList<>();
        bonusMalusListEx17.add(bonusMalusEx17);
        bonusMalusSetEx17.addEndBonusMalus(bonusMalusListEx17);
        DonateBonusMalusEffect bonusMalusEffectEx17 = new DonateBonusMalusEffect(bonusMalusSetEx17);
        bonusMalusEffectsEx17.add(bonusMalusEffectEx17);
        ExcomunicationCard cardEx17 = new ExcomunicationCard(eraEx17, nameEx17, bonusMalusEffectsEx17);
        cards.add(cardEx17);
        int eraEx18 = 3;
        String nameEx18 = "ex_18_era_3";
        List<Effect> bonusMalusEffectsEx18 = new ArrayList<>();
        BonusMalusSet bonusMalusSetEx18 = new BonusMalusSet();
        List<Resource> activeListEx18 = new ArrayList<>();
        activeListEx18.add(Resource.MILITARYPOINT);
        BonusMalusOnEnd bonusMalusEx18 = new BonusMalusOnEnd(Resource.VICTORYPOINT, activeListEx18, ActionType.END_GAME, 1.0, true);
        List<BonusMalusOnEnd> bonusMalusListEx18 = new ArrayList<>();
        bonusMalusListEx18.add(bonusMalusEx18);
        bonusMalusSetEx18.addEndBonusMalus(bonusMalusListEx18);
        DonateBonusMalusEffect bonusMalusEffectEx18 = new DonateBonusMalusEffect(bonusMalusSetEx18);
        bonusMalusEffectsEx18.add(bonusMalusEffectEx18);
        ExcomunicationCard cardEx18 = new ExcomunicationCard(eraEx18, nameEx18, bonusMalusEffectsEx18);
        cards.add(cardEx18);
        int eraEx19 = 3;
        String nameEx19 = "ex_19_era_3";
        List<Effect> bonusMalusEffectsEx19 = new ArrayList<>();
        BonusMalusSet bonusMalusSetEx19 = new BonusMalusSet();
        List<Resource> activeListEx19 = new ArrayList<>();
        activeListEx19.add(Resource.MONEY);
        activeListEx19.add(Resource.WOOD);
        activeListEx19.add(Resource.STONE);
        activeListEx19.add(Resource.SERVANT);
        BonusMalusOnEnd bonusMalusEx19 = new BonusMalusOnEnd(Resource.VICTORYPOINT, activeListEx19, ActionType.END_GAME, 1.0, true);
        List<BonusMalusOnEnd> bonusMalusListEx19 = new ArrayList<>();
        bonusMalusListEx19.add(bonusMalusEx19);
        bonusMalusSetEx19.addEndBonusMalus(bonusMalusListEx19);
        DonateBonusMalusEffect bonusMalusEffectEx19 = new DonateBonusMalusEffect(bonusMalusSetEx19);
        bonusMalusEffectsEx19.add(bonusMalusEffectEx19);
        ExcomunicationCard cardEx19 = new ExcomunicationCard(eraEx19, nameEx19, bonusMalusEffectsEx19);
        cards.add(cardEx19);
    ...
    public void writeHeroCards() throws IOException {
        ...
        boolean permanentHe1 = true;//TODO da capire se è da mettere false o true per quelli che si attivano una volta a turno
        ...
        cards.add(cardHe3);
        String nameHe4 = "leaders_f_c_14";
        HashMap<String, Integer> cardConditionsHe4 = new HashMap<>();
        ResourceSet resourcesConditionHe4 = new ResourceSet();
        ArrayList<Effect> effectListHe4 = new ArrayList<>();
        String cardTypeHe4 = "HEROES";
        boolean permanentHe4 = true;
        resourcesConditionHe4.variateResource(Resource.MILITARYPOINT, 7);
        resourcesConditionHe4.variateResource(Resource.FAITHPOINT, 3);
        LinkedList<String> targetColoursHe4 = new LinkedList<>();
        targetColoursHe4.add("");
        BonusMalusOnAction bonusMalusHe4 = new BonusMalusOnAction("", targetColoursHe4, ActionType.GENERAL, true, 3);
        BonusMalusSet bonusMalusSetHe4 = new BonusMalusSet();
        List<BonusMalusOnAction> bonusMalusListHe4 = new ArrayList<>();
        bonusMalusListHe4.add(bonusMalusHe4);
        bonusMalusSetHe4.addActionBonusMalus(bonusMalusListHe4);
        DonateBonusMalusEffect effectHe4 = new DonateBonusMalusEffect(bonusMalusSetHe4);
        effectListHe4.add(effectHe4);
        HeroCard cardHe4 = new HeroCard(nameHe4, cardConditionsHe4, resourcesConditionHe4, effectListHe4, permanentHe4, cardTypeHe4);
        cards.add(cardHe4);
        String nameHe5 = "leaders_f_c_05";
        HashMap<String, Integer> cardConditionsHe5 = new HashMap<>();
        ResourceSet resourcesConditionHe5 = new ResourceSet();
        ArrayList<Effect> effectListHe5 = new ArrayList<>();
        String cardTypeHe5 = "HEROES";
        boolean permanentHe5 = true;
        resourcesConditionHe5.variateResource(Resource.MONEY, 18);
        /*BonusMalusOnResources bonusMalusHe5 = new BonusMalusOnResources(Resource.FAITHPOINT, 1, ActionType.PLAY_HERO_CARD, true);
        BonusMalusSet bonusMalusSetHe5 = new BonusMalusSet();
        List<BonusMalusOnResources> bonusMalusListHe5 = new ArrayList<>();
        bonusMalusListHe5.add(bonusMalusHe5);
        bonusMalusSetHe5.addResourceBonusMalus(bonusMalusListHe5);
        DonateBonusMalusEffect effectHe5 = new DonateBonusMalusEffect(bonusMalusSetHe5);
        effectListHe5.add(effectHe5);*/
        ResourceSet variationHe5 = new ResourceSet();
        variationHe5.variateResource(Resource.FAITHPOINT, 1);
        EffectOnResources effectHe5 = new EffectOnResources(variationHe5);
        effectListHe5.add(effectHe5);
        HeroCard cardHe5 = new HeroCard(nameHe5, cardConditionsHe5, resourcesConditionHe5, effectListHe5, permanentHe5, cardTypeHe5);
        cards.add(cardHe5);
        String nameHe6 = "leaders_f_c_08";
        HashMap<String, Integer> cardConditionsHe6 = new HashMap<>();
        ResourceSet resourcesConditionHe6 = new ResourceSet();
        ArrayList<Effect> effectListHe6 = new ArrayList<>();
        String cardTypeHe6 = "HEROES";
        boolean permanentHe6 = true;
        resourcesConditionHe6.variateResource(Resource.STONE, 10);
        /*BonusMalusOnResources bonusMalusHe6 = new BonusMalusOnResources(Resource.MONEY, 3, ActionType.PLAY_HERO_CARD, true);
        BonusMalusSet bonusMalusSetHe6 = new BonusMalusSet();
        List<BonusMalusOnResources> bonusMalusListHe6 = new ArrayList<>();
        bonusMalusListHe6.add(bonusMalusHe6);
        bonusMalusSetHe6.addResourceBonusMalus(bonusMalusListHe6);
        DonateBonusMalusEffect effectHe6 = new DonateBonusMalusEffect(bonusMalusSetHe6);
        effectListHe6.add(effectHe6);*/
        ResourceSet variationHe6 = new ResourceSet();
        variationHe6.variateResource(Resource.MONEY, 3);
        EffectOnResources effectHe6 = new EffectOnResources(variationHe6);
        HeroCard cardHe6 = new HeroCard(nameHe6, cardConditionsHe6, resourcesConditionHe6, effectListHe6, permanentHe6, cardTypeHe6);
        cards.add(cardHe6);
        String nameHe7 = "leaders_f_c_06";
        HashMap<String, Integer> cardConditionsHe7 = new HashMap<>();
        ResourceSet resourcesConditionHe7 = new ResourceSet();
        ArrayList<Effect> effectListHe7 = new ArrayList<>();
        String cardTypeHe7 = "HEROES";
        boolean permanentHe7 = true;
        resourcesConditionHe7.variateResource(Resource.MILITARYPOINT, 12);
        /*BonusMalusOnResources bonusMalusHe7 = new BonusMalusOnResources(Resource.MONEY, 1, ActionType.PLAY_HERO_CARD, true);
        BonusMalusOnResources bonusMalusHe7 = new BonusMalusOnResources(Resource.STONE, 1, ActionType.PLAY_HERO_CARD, true);
        BonusMalusOnResources bonusMalusHe7 = new BonusMalusOnResources(Resource.WOOD, 1, ActionType.PLAY_HERO_CARD, true);
        BonusMalusSet bonusMalusSetHe7 = new BonusMalusSet();
        List<BonusMalusOnResources> bonusMalusListHe7 = new ArrayList<>();
        bonusMalusListHe7.add(bonusMalusHe7);
        bonusMalusSetHe7.addResourceBonusMalus(bonusMalusListHe7);
        DonateBonusMalusEffect effectHe7 = new DonateBonusMalusEffect(bonusMalusSetHe7);
        effectListHe7.add(effectHe7);*/
        ResourceSet variationHe7 = new ResourceSet();
        variationHe7.variateResource(Resource.MONEY, 1);
        variationHe7.variateResource(Resource.STONE, 1);
        variationHe7.variateResource(Resource.WOOD, 1);
        EffectOnResources effectHe7 = new EffectOnResources(variationHe7);
        HeroCard cardHe7 = new HeroCard(nameHe7, cardConditionsHe7, resourcesConditionHe7, effectListHe7, permanentHe7, cardTypeHe7);
        cards.add(cardHe7);
        String nameHe8 = "leaders_f_c_10";
        HashMap<String, Integer> cardConditionsHe8 = new HashMap<>();
        ResourceSet resourcesConditionHe8 = new ResourceSet();
        ArrayList<Effect> effectListHe8 = new ArrayList<>();
        String cardTypeHe8 = "HEROES";
        boolean permanentHe8 = true;
        cardConditionsHe8.put("BLUE", 4);
        cardConditionsHe8.put("GREEN", 2);
        DonateProdHarv effectHe8 = new DonateProdHarv(0, ActionType.PRODUCTION_ACTION);
        effectListHe8.add(effectHe8);
        HeroCard cardHe8 = new HeroCard(nameHe8, cardConditionsHe8, resourcesConditionHe8, effectListHe8, permanentHe8, cardTypeHe8);
        cards.add(cardHe8);
        String nameHe9 = "leaders_f_c_07";
        HashMap<String, Integer> cardConditionsHe9 = new HashMap<>();
        ResourceSet resourcesConditionHe9 = new ResourceSet();
        ArrayList<Effect> effectListHe9 = new ArrayList<>();
        String cardTypeHe9 = "HEROES";
        boolean permanentHe9 = true;
        cardConditionsHe9.put("GREEN", 2);
        cardConditionsHe9.put("BLUE", 2);
        cardConditionsHe9.put("PURPLE", 2);
        cardConditionsHe9.put("YELLOW", 2);
        /*BonusMalusOnResources bonusMalusHe9 = new BonusMalusOnResources(Resource.MILITARYPOINT, 2, ActionType.PLAY_HERO_CARD, true);
        BonusMalusOnResources bonusMalusHe9 = new BonusMalusOnResources(Resource.VICTORYPOINT, 1, ActionType.PLAY_HERO_CARD, true);        BonusMalusSet bonusMalusSetHe9 = new BonusMalusSet();
        List<BonusMalusOnResources> bonusMalusListHe9 = new ArrayList<>();
        bonusMalusListHe9.add(bonusMalusHe9);
        bonusMalusSetHe9.addResourceBonusMalus(bonusMalusListHe9);
        DonateBonusMalusEffect effectHe9 = new DonateBonusMalusEffect(bonusMalusSetHe9);
        effectListHe9.add(effectHe9);*/
        ResourceSet variationHe9 = new ResourceSet();
        variationHe9.variateResource(Resource.MILITARYPOINT, 2);
        variationHe9.variateResource(Resource.VICTORYPOINT, 1);
        EffectOnResources effectHe9 = new EffectOnResources(variationHe9);
        HeroCard cardHe9 = new HeroCard(nameHe9, cardConditionsHe9, resourcesConditionHe9, effectListHe9, permanentHe9, cardTypeHe9);
        cards.add(cardHe9);
        String nameHe10 = "leaders_f_c_03";
        HashMap<String, Integer> cardConditionsHe10 = new HashMap<>();
        ResourceSet resourcesConditionHe10 = new ResourceSet();
        ArrayList<Effect> effectListHe10 = new ArrayList<>();
        String cardTypeHe10 = "HEROES";
        boolean permanentHe10 = true;
        cardConditionsHe10.put("YELLOW", 5);
        List<String> coloursHe10 = new ArrayList<>();
        coloursHe10.add("GREEN");
        coloursHe10.add("BLUE");
        coloursHe10.add("PURPLE");
        coloursHe10.add("YELLOW");
        BonusMalusOnSettings bonusMalusHe10 = new BonusMalusOnSettings(3, coloursHe10, ActionType.PAYCARDACTION);
        BonusMalusSet bonusMalusSetHe10 = new BonusMalusSet();
        List<BonusMalusOnSettings> bonusMalusListHe10 = new ArrayList<>();
        bonusMalusListHe10.add(bonusMalusHe10);
        bonusMalusSetHe10.addBonusMalusOnSettings(bonusMalusListHe10);
        DonateBonusMalusEffect effectHe10 = new DonateBonusMalusEffect(bonusMalusSetHe10);
        effectListHe10.add(effectHe10);
        HeroCard cardHe10 = new HeroCard(nameHe10, cardConditionsHe10, resourcesConditionHe10, effectListHe10, permanentHe10, cardTypeHe10);
        cards.add(cardHe10);
        String nameHe11 = "leaders_f_c_19";
        HashMap<String, Integer> cardConditionsHe11 = new HashMap<>();
        ResourceSet resourcesConditionHe11 = new ResourceSet();
        ArrayList<Effect> effectListHe11 = new ArrayList<>();
        String cardTypeHe11 = "HEROES";
        boolean permanentHe11 = true;
        cardConditionsHe11.put("GREEN", 4);
        cardConditionsHe11.put("PURPLE", 4);
        ResourceSet variationHe11 = new ResourceSet();
        variationHe11.variateResource(Resource.SERVANT, 3);
        variationHe11.variateResource(Resource.VICTORYPOINT, 1);
        EffectOnResources effectHe11 = new EffectOnResources(variationHe11);
        effectListHe11.add(effectHe11);
        HeroCard cardHe11 = new HeroCard(nameHe11, cardConditionsHe11, resourcesConditionHe11, effectListHe11, permanentHe11, cardTypeHe11);
        cards.add(cardHe11);
        String nameHe12 = "leaders_f_c_20";
        HashMap<String, Integer> cardConditionsHe12 = new HashMap<>();
        ResourceSet resourcesConditionHe12 = new ResourceSet();
        ArrayList<Effect> effectListHe12 = new ArrayList<>();
        String cardTypeHe12 = "HEROES";
        boolean permanentHe12 = true;
        cardConditionsHe12.put("YELLOW", 4);
        cardConditionsHe12.put("BLUE", 4);
        ResourceSet variationHe12 = new ResourceSet();
        variationHe12.variateResource(Resource.VICTORYPOINT, 4);
        EffectOnResources effectHe12 = new EffectOnResources(variationHe12);
        effectListHe12.add(effectHe12);
        HeroCard cardHe12 = new HeroCard(nameHe12, cardConditionsHe12, resourcesConditionHe12, effectListHe12, permanentHe12, cardTypeHe12);
        cards.add(cardHe12);
        String nameHe13 = "leaders_f_c_09";
        HashMap<String, Integer> cardConditionsHe13 = new HashMap<>();
        ResourceSet resourcesConditionHe13 = new ResourceSet();
        ArrayList<Effect> effectListHe13 = new ArrayList<>();
        String cardTypeHe13 = "HEROES";
        boolean permanentHe13 = true;
        resourcesConditionHe13.variateResource(Resource.SERVANT, 15);
        EffectOnParchment effectHe13 = new EffectOnParchment(1,false);
        effectListHe13.add(effectHe13);
        HeroCard cardHe13 = new HeroCard(nameHe13, cardConditionsHe13, resourcesConditionHe13, effectListHe13, permanentHe13, cardTypeHe13);
        cards.add(cardHe13);
        String nameHe14 = "leaders_f_c_11";
        HashMap<String, Integer> cardConditionsHe14 = new HashMap<>();
        ResourceSet resourcesConditionHe14 = new ResourceSet();
        ArrayList<Effect> effectListHe14 = new ArrayList<>();
        String cardTypeHe14 = "HEROES";
        boolean permanentHe14 = true;
        cardConditionsHe14.put("YELLOW", 2);
        cardConditionsHe14.put("PURPLE", 4);
        List<String> coloursHe14 = new ArrayList<>();
        coloursHe14.add("GREEN");
        coloursHe14.add("BLUE");
        coloursHe14.add("PURPLE");
        coloursHe14.add("YELLOW");
        ResourceSet bonusEntityHe14 = new ResourceSet();
        //TODO ci vuole il + o il - 3 per scontare la carta di tre monete?
        bonusEntityHe14.variateResource(Resource.MONEY, 3);
        BonusMalusOnCost bonusMalusHe14 = new BonusMalusOnCost(bonusEntityHe14, coloursHe14, ActionType.PAYCARDACTION, true);
        BonusMalusSet bonusMalusSetHe14 = new BonusMalusSet();
        List<BonusMalusOnCost> bonusMalusListHe14 = new ArrayList<>();
        bonusMalusListHe14.add(bonusMalusHe14);
        bonusMalusSetHe14.addCostBonusMalus(bonusMalusListHe14);
        DonateBonusMalusEffect effectHe14 = new DonateBonusMalusEffect(bonusMalusSetHe14);
        effectListHe14.add(effectHe14);
        HeroCard cardHe14 = new HeroCard(nameHe14, cardConditionsHe14, resourcesConditionHe14, effectListHe14, permanentHe14, cardTypeHe14);
        cards.add(cardHe14);
